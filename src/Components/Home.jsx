                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
                                <div className="bg-white p-8 md:p-16 border-2 border-slate-200">
                                    <div className="flex items-center gap-4 md:gap-6 mb-6 md:mb-10">
                                        <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 30'%3E%3Cpath fill='%23FF0000' d='M0 0h60v10H0z'/%3E%3Cpath fill='%23FFFFFF' d='M0 10h60v10H0z'/%3E%3Cpath fill='%23000000' d='M0 20h60v10H0z'/%3E%3C/svg%3E" alt="UAE" className="w-12 h-8 md:w-16 md:h-10 rounded" />
